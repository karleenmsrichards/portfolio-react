        ...
        <div className="more-about-me-text">
          ...
          <div className="more-about-me-text-content-wrapper">
            ...
            <p className="more-about-me-text-content">
              ...
              <span className="text-dark">September 2022</span> and it continues
              to be an honour to serve as a member of the Board. I have been
              ...
              the charity in 2023. I have also visited a few schools on Afril's
              behalf during <span className="text-dark">Refugee Week 2023</span>{" "}
              in aid of Refugee awareness.
            </p>
          </div>
