  ...
  const handleClose = () => setShowMenu(false);
    ...
    return (
      <header>
        ...
        <a className="nav-btn" href="https://github.com/your_username" target="_blank" rel="noopener noreferrer">
          <img className="social-media-icon" src={githubIcon} alt="GitHub" />
        </a>
      
        <a className="nav-btn" href="https://linkedin.com/in/your_profile" target="_blank" rel="noopener noreferrer">
           <img  className="social-media-icon" src={linkedInIcon} alt="LinkedIn" />
        </a>
        </div>
